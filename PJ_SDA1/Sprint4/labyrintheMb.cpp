 ...
 * @brief Permet d'affecter et de réinitialiser le labyrinthe, et d'afficher le sprint 4
 * Projet SDA 1
 */
 ...
 * @see missionDragonSp3, afin d'effectuer le sprint 4 et provoquer son affichage par l'appel de cette fonction
