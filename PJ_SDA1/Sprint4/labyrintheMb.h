/**
 * @file labyrintheMb.h
 * @brief Permet d'initialiser et de réinitialiser le labyrinthe, et d'afficher le sprint 4
 * Projet SDA 1
 */
#pragma once
...
/**
 * @brief Affiche le Sprint 4
 * @see missionDragonSp2, afin d'effectuer le sprint 4 et provoquer son affichage par l'appel de cette fonction
 * @param[in] lab : Labyrinthe contenant le tableau 3D et ses dimensions
 * @pre lab(.tab, .col, .lin) est initialisé
 */
void affichersp4(Lab& lab);